# an object that will be interacting with td ameritrade api
# where we send messages back and forth from the api, maintsaining sessions, creating other object
#  whatever it be, this will be the access point

import pandas as pdb 

# how we create new client, new session and maintain the session as we are interacting with the api
# (refreshing the access token, making request, building headers, and validating the arguments and etc)
